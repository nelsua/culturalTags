...
public class Logic extends WordsMeaning{
    ...
    //complete meaning of the cards is storaged here
      private String wth = wth(); String lalaland = lalaland(); String mma = mma();
              String ww2 = ww2();String rt = rt(); String ftp = ftp();
              String nasa = nasa(); String asap = asap(); String dob = dob();
              String idk =  idk(); String bff =  bff(); String mia = mia();
            ...
            public void biggerNumberStart(int x, int y){
                ...
                String winnerNumber = (x>y) ? "Team A is guessing\t"+x : "Team B is guessing\t"+y;
                System.out.println(winnerNumber);
            }
            public void addPlayerA(TeamA tA, int amountOfpPlayers){
            ...
            public void addPlayerB(TeamB tB, int amountOfpPlayers){
                Scanner sc =new Scanner(System.in);
                int count=0;
                do{
                    System.out.println("insert players");
